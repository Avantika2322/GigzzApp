...
class AllJobsAdapter(
...
) : ListAdapter<JobsData, AllJobsAdapter.MyViewHolder>(AllJobsDiffCallback) {
    ...
    inner class MyViewHolder(private val binding: ItemJobsGigzzBinding) :
    ...
    object AllJobsDiffCallback : DiffUtil.ItemCallback<JobsData>() {
